...
if __name__ == "__main__":
    ...
    skeleton_2d = np.load(
        "./dataset/skeletons_2d/{}/{}/{}_{:03d}.npy".format(class_type, class_name, class_name, video_idx))[frame_idx]
    skeleton_3d = np.load(
        "./dataset/skeletons_3d/{}/{}/{}_{:03d}.npy".format(class_type, class_name, class_name, video_idx))[frame_idx]
